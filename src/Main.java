public class Main {
    ...
    private static void printFullNameOfSotrufnik() {
        for (int i = 0; i < sotrudnik.length; i++) {
            System.out.println(sotrudnik[i].getFullName());
        }
    }
    ...
    private static Sotrudnik findSotrudnikWithMaxSalary() {
        ...
        for (int i = 0; i < sotrudnik.length; i++) {
            if (sotrudnik[i].getSalary() > maxSalary) {
                maxSalary = sotrudnik[i].getSalary();
                sotrudnikWithMaxSalary = sotrudnik[i];
            }
        }
    ...
    private static Sotrudnik findSotrudnikWithMinSalary() {
        ...
        for (int i = 0; i < sotrudnik.length; i++) {
            if (sotrudnik[i].getSalary() < minSalary) {
                minSalary = sotrudnik[i].getSalary();
                sotrudnikWithMinSalary = sotrudnik[i];
            }
        }
